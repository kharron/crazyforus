# Django settings for crazyforus project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    # ('Kharron Reid', 'kharronreid@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'crazyforus',                      # Or path to database file if using sqlite3.
    ...
    'geoipdata': {
        'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'geoipdata',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'root',
        'PASSWORD': 'helium',
        'HOST': '',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
    ...
    'wp_crazy': {
        'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'wordpress_crazyforus',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'root',
        'PASSWORD': 'helium',
				'HOST': '',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
SECRET_KEY = '^jrjqt&4x#&mgw(3y%-(i8(o!=y3c@ll^wco7^@gvwpr7*p+we'
...
ROOT_URLCONF = 'crazyforus.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'crazyforus.wsgi.application'
