...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Articles.original_date'
        db.alter_column(u'aggregator_articles', 'original_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Articles.original_date'
        db.alter_column(u'aggregator_articles', 'original_date', self.gf('django.db.models.fields.DateField')(null=True))
