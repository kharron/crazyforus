...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Articles.legacy_postid'
        db.add_column(u'aggregator_articles', 'legacy_postid',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Articles.legacy_postid'
        db.delete_column(u'aggregator_articles', 'legacy_postid')
    ...
    models = {
        ...
        u'aggregator.articles': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'legacy_postid': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
