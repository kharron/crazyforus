...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Articles.times_viewed'
        db.add_column(u'aggregator_articles', 'times_viewed',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Articles.times_viewed'
        db.delete_column(u'aggregator_articles', 'times_viewed')
